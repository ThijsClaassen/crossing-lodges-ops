...
export const T = {
  bg:       "var(--surface)",   // deep navy — darkened logo navy
  panel:    "var(--surface-raised)",   // slightly lighter navy for cards/sidebar
  border:   "var(--line)",   // muted navy border
  navy:     "var(--surface-overlay)",   // exact logo navy
  navyLt:   "var(--line)",   // hover states
  slate:    "var(--surface-overlay)",   // logo slate grey
  gold:     "var(--accent)",   // warm gold accent (safari feel, brand-compatible)
  goldLt:   "var(--accent-hover)",   // gold hover
  cream:    "var(--text)",   // warm off-white text
  muted:    "var(--text-muted)",   // muted text on dark
  danger:   "var(--critical)",
  ok:       "var(--success)",
  fuel_d:   "var(--series-5)",   // diesel blue
  fuel_p:   "var(--series-6)",   // petrol red
};
